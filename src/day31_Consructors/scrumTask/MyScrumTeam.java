package day31_Consructors.scrumTask;
...
public class MyScrumTeam {
    public static void main(String[] args) {
        ...
        Tester[] testres = {tester2,tester3,tester4};
...
Testers and add the testers from your group
                    2. create an array of
developers add the developers from your group
                    3. create an object of
ScrumTeam and store the testers & developers above to the scrum team
 */