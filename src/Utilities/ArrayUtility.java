...
public class ArrayUtility {
    ...
    // returns the maximum number for char array
    ...
    // returns the minimum number for char array
    ...
    //check if the given integer is contained in the given array, returns boolean(int[] , int)

    public static boolean contains(int[] array, int element) {
        boolean result = false;
        for (int each : array) {
            if (each == element) {// if  any array's element is matching with the given element, it means the given elements is contains array
                result = true;
            }
        }
        return result;
    ...
    //check if the given char is contained in the given array,returns boolean(char [] , char)
    ...
    // merge the given two arrays and returns the array
